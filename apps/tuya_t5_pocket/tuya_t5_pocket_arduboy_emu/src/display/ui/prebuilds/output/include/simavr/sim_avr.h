...
void avr_set_platform_time_source(avr_t * avr, uint64_t (*time_ns_cb)(struct avr_t * avr));
void avr_set_platform_sleep_handler(avr_t * avr, void (*sleep_us_cb)(struct avr_t * avr, uint32_t sleep_us));
...
/* Platform hook registration (optional) */
void
avr_set_platform_time_source(
		avr_t * avr,
		uint64_t (*time_ns_cb)(struct avr_t * avr));
void
avr_set_platform_sleep_handler(
		avr_t * avr,
